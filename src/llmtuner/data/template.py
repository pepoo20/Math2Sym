...
from prompt import Math_Teacher_Prompt,Math_Teacher_Prompt_Word
...
_register_template(
    name="WordProblemMathLLama",
    format_user=StringFormatter(slots=["Question: {{content}} \n Answer: "]),
    format_system=StringFormatter(slots=["{{content}}\n"]),
    format_separator=EmptyFormatter(slots=["\n"]),
    default_system="You are a Math Teacher. Your goal is to understand a math word problem. Then identify the problem type and define the variables (if needed) and formulate the problem as it is and then transform it to Symbolic Form.",
)
...
_register_template(
    name = "WordProblemProbability",
    format_user=StringFormatter(slots=["Question: {{content}} \n Answer: "]),
    format_system=StringFormatter(slots=["{{content}}\n"]),
    format_separator=EmptyFormatter(slots=["\n"]),
    default_system="You are a Math Teacher specializing in probability and combinatorics. Your goal is to understand a math word problem,Identify the problem type to formulate the problem as it is and then transform it to Symbolic Form.",
)